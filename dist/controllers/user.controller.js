...
exports.updateUserLocation = exports.deductPoints = exports.addPoints = exports.loginUser = exports.registerUser = exports.getUserPoints = exports.getUserById = exports.getUsers = void 0;
...
//@access private
exports.updateUserLocation = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default.findById(req.params.id);
    if (user) {
        const location = user.locations.find((location) => location.name === req.body.location);
        if (location) {
